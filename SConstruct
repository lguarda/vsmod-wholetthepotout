...
wholtpo_mod_info = setup_modinfo(env, "Wholtpo", False, True, "wholtpo", "Who let the pot out", "Switch back cooking pot into the firepit when interacting with it, and it's client side only")
